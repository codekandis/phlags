...
namespace CodeKandis\Phlags\Tests\DataProviders\UnitTests\Validation\InvalidFlagableExceptionInterfaceTest;
	...
	public static function provideData(): iterable
	{
		return [
			0 => [
				...
				'expectedThrowableMessage'   => sprintf( InvalidFlagableException::EXCEPTION_MESSAGE_FLAGABLE_IS_INVALID, $invalidFlagableClassName )
			]
		];
	}
}
