...
use CodeKandis\Phlags\Tests\DataProviders\UnitTests\FlagableInterfaceTest\ValidFlagablesWithInvalidValueExpectedExceptionClassNameAndExpectedExceptionMessageDataProvider;
...
{
	/**
	 * Tests if calling `unset()` on an undefined member throws a `CodeKandis\Phlags\UnsupportedOperationException`.
	...
	public function testIfCallingUnsetOnUndefinedMemberThrowsUnsupportedOperationExceptionInterface( AbstractFlagable $validFlagable, string $undefinedMemberName, string $expectedThrowableClassName, string $expectedThrowableMessage ): void
	{
		try
		{
		...
		{
			static::assertInstanceOf( UnsupportedOperationExceptionInterface::class, $throwable );
	...
	/**
	 * Tests if getting the value of an undefined member throws a `CodeKandis\Phlags\UnsupportedOperationException`.
	 * @param AbstractFlagable $validFlagable The valid flagable to test.
	 ...
	 */
	#[DataProviderExternal( ValidFlagablesWithUndefinedMemberNameExpectedThrowableClassNameAndExpectedThrowableMessageDataProvider::class, 'provideData' )]
	public function testIfGettingTheValueOfUndefinedMemberThrowsUnsupportedOperationExceptionInterface( AbstractFlagable $validFlagable, string $undefinedMemberName, string $expectedThrowableClassName, string $expectedThrowableMessage ): void
	{
		try
		{
	 ...
	 */
	#[DataProviderExternal( ValidFlagablesWithUndefinedMemberNameExpectedThrowableClassNameAndExpectedThrowableMessageDataProvider::class, 'provideData' )]
	public function testIfSettingTheValueOfUndefinedMemberThrowsUnsupportedOperationExceptionInterface( AbstractFlagable $validFlagable, string $undefinedMemberName, string $expectedThrowableClassName, string $expectedThrowableMessage ): void
	{
		try
		{
	...
	/**
	 * Tests if calling an undefined method throws a `CodeKandis\Phlags\UnsupportedOperationException`.
	 * @param AbstractFlagable $validFlagable The valid flagable to test.
	...
	public function testIfCallingUndefinedMethodThrowsUnsupportedOperationExceptionInterface( AbstractFlagable $validFlagable, string $undefinedMethodName, string $expectedThrowableClassName, string $expectedThrowableMessage ): void
	{
		try
		{
	...
	/**
	 * Tests if accessing an undefined static method throws a `CodeKandis\Phlags\UnsupportedOperationException`.
	 * @param AbstractFlagable $validFlagable The valid flagable to test.
	...
	public function testIfCallingUndefinedStaticMethodThrowsUnsupportedOperationExceptionInterface( AbstractFlagable $validFlagable, string $undefinedStaticMethodName, string $expectedThrowableClassName, string $expectedThrowableMessage ): void
	{
		try
		{
	 ...
	 * @param string $expectedThrowableMessage The message of the expected throwable.
	 */
	#[DataProviderExternal( ValidFlagablesWithInvalidValueExpectedExceptionClassNameAndExpectedExceptionMessageDataProvider::class, 'provideData' )]
