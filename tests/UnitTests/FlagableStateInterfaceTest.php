...
use CodeKandis\Phlags\Tests\DataProviders\UnitTests\FlagableStateInterfaceTest\FlagableStatesWithReflectedValuesAndExpectedReflectedValuesDataProvider;
use CodeKandis\Phlags\Tests\DataProviders\UnitTests\FlagableStateInterfaceTest\FlagableStatesWithValidationExceptionAndExpectedValidationExceptionDataProvider;
...
class FlagableStateInterfaceTest extends TestCase
{
	 ...
	 */
	#[DataProviderExternal( FlagableStatesWithValidationExceptionAndExpectedValidationExceptionDataProvider::class, 'provideData' )]
	 ...
	 */
	#[DataProviderExternal( FlagableStatesWithReflectedValuesAndExpectedReflectedValuesDataProvider::class, 'provideData' )]
