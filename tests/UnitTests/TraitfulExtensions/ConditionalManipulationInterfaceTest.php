...
use CodeKandis\Phlags\Tests\DataProviders\UnitTests\TraitfulExtensions\ConditionalManipulationInterfaceTest\ValidConditionalManipulationFlagablesWithInvalidValueExpectedExceptionClassNameAndExpectedExceptionMessageDataProvider;
...
class ConditionalManipulationInterfaceTest extends TestCase
{
	 ...
	 */
	#[DataProviderExternal( ValidConditionalManipulationFlagablesWithInvalidValueExpectedExceptionClassNameAndExpectedExceptionMessageDataProvider::class, 'provideData' )]
